      ...
      <div className="flex flex-col md:flex-row gap-3 w-full">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-3.5 rounded-xl bg-[var(--glass-bg)] border border-[var(--glass-border)] text-sm font-medium text-[var(--text-main)] placeholder:text-[var(--text-muted)] outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/30 transition-all backdrop-blur-sm"
          />
          {/* City Suggestions */}
          <AnimatePresence>
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-3.5 rounded-xl bg-[var(--glass-bg)] border border-[var(--glass-border)] text-sm font-medium text-[var(--text-main)] placeholder:text-[var(--text-muted)] outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400/30 transition-all backdrop-blur-sm"
          />
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl font-bold text-xs uppercase tracking-widest bg-[var(--glass-bg)] border border-[var(--glass-border)] text-[var(--text-muted)] hover:text-cyan-400 hover:border-cyan-400/40 hover:bg-cyan-400/5 disabled:opacity-60 disabled:cursor-not-allowed transition-all backdrop-blur-sm whitespace-nowrap shrink-0"
        >
          {locating ? (
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-black text-xs uppercase tracking-widest bg-gradient-to-r from-cyan-400 to-purple-500 text-white shadow-lg hover:shadow-cyan-400/25 transition-all shrink-0"
        >
          <Search size={15} />
